...
const exercises: Record<MuscleGroup, Exercise[]> = {
  ...
  shoulders: [
    {
      ...
      steps: [
        ...
        "Сделайте вдох и напрягите плечи",
        "Поднимите локти вверх, ведя штангу вдоль тела",
        "Доведите гриф до уровня подбородка",
  ...
  glutes: [
    {
      id: "g1",
      title: "Выпады в Смите с акцентом на ягодицы",
      muscle: "на ягодицы",
      level: "Новичкам",
      videoThumb: "/images/exercise-glutes-1.jpg",
      videoUrl: "https://res.cloudinary.com/dq7aekly8/video/upload/v1773485192/IMG_4597_gnsgpd.mp4",
      goal: "Развитие ягодичных мышц и задней поверхности бедра",
      steps: [
        "Установите штангу в тренажёре Смита на уровень плеч",
        "Сделайте шаг вперёд одной ногой",
        "Опускайтесь вниз, сгибая колени",
        "Заднее колено направляйте к полу",
        "Переднюю ногу держите на пятке",
        "Поднимитесь вверх, выталкивая себя пяткой",
        "Выполните нужное количество повторений и поменяйте ногу",
      ],
      important: [
        "Корпус слегка наклонён вперёд для акцента на ягодицы",
        "Основная нагрузка на переднюю ногу",
        "Не переносите вес на носок",
    ...
    },
    {
      ...
      muscle: "на ягодицы",
      level: "Новичкам",
      videoThumb: "/images/exercise-glutes-2.jpg",
      videoUrl: "https://res.cloudinary.com/dq7aekly8/video/upload/v1773485192/IMG_4598_ynzh11.mp4",
      goal: "Развитие ягодиц и задней поверхности бедра",
      steps: [
        "Установите штангу на верх трапеций",
        "Поставьте ноги на ширине плеч",
        "Слегка согните колени",
        "Наклоните корпус вперёд, отводя таз назад",
        "Опуститесь до ощущения растяжения ягодиц",
        "Поднимитесь вверх, выпрямляя корпус",
      ],
      important: [
        "Спина остаётся прямой на протяжении всего движения",
        "Движение начинается с отведения таза назад",
        "Не округляйте поясницу",
        "Движение выполняйте плавно",
      ],
      suitable: ["Начинающим", "Средний уровень"],
    },
    {
      id: "g3",
      title: "Ягодичный наклон (Hip Thrust)",
      muscle: "на ягодицы",
      level: "Новичкам",
      videoThumb: "/images/exercise-glutes-3.jpg",
      videoUrl: "https://res.cloudinary.com/dq7aekly8/video/upload/v1773485192/IMG_4599_rliqbm.mp4",
      goal: "Рост силы и объёма ягодичных мышц",
      steps: [
        "Сядьте на пол, лопатками упритесь в скамью",
        "Поставьте ноги на ширине плеч",
        "Разместите штангу или вес на тазе",
        "Поднимите таз вверх, напрягая ягодицы",
        "В верхней точке задержитесь на секунду",
        "Медленно опустите таз вниз",
      ],
      important: [
        "В верхней точке полностью сжимайте ягодицы",
        "Не прогибайте сильно поясницу",
    ...
    {
      id: "g4",
      title: "Румынская тяга / Сумо",
      muscle: "на ягодицы",
      level: "Новичкам",
      videoThumb: "/images/exercise-glutes-4.jpg",
      videoUrl: "https://res.cloudinary.com/dq7aekly8/video/upload/v1773485192/IMG_4600_k7nwpl.mp4",
      goal: "Развитие ягодиц и задней поверхности бедра",
      steps: [
        "Поставьте ноги шире плеч, носки слегка в стороны",
        "Возьмитесь за штангу или гирю",
        "Отведите таз назад",
        "Опускайте вес вниз вдоль ног",
        "Опуститесь до растяжения ягодиц",
        "Поднимитесь вверх, выпрямляя корпус",
      ],
      important: [
        "Спина остаётся прямой",
        "Вес держите близко к ногам",
        "Движение начинается с отведения таза назад",
        "Поднимайтесь за счёт ягодиц",
      ],
      suitable: ["Начинающим", "Средний уровень"],
    },
  ],
