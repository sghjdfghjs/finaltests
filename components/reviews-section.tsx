...
const reviews: Review[] = [
  ...
  },
  {
    ...
    rating: 5,
    date: "19.01.2026",
    text: "Хочу выразить огромную благодарность тренеру яну за профессионализм и внимательное отношение. Ян подробно объясняет технику выполнения упражнений, следит за безопасностью и мотивирует двигаться к результату. Отдельно хочется отметить позитивный настрой и умение вдохновлять в моменты, когда кажется, что сил уже нет. Мне тренировки приносят не только результат, но и удовольствие.",
  },
  {
    name: "Ирина",
    rating: 5,
    date: "19.01.2026",
    text: "Первая тренировка с тренером прошла отлично! Он внимательно выслушал мои пожелания, показал технику на базовых упражнениях, объяснил, как правильно дышать. Чувствуется, что программа построена под меня, а не \"на отвали\". Было тяжело, но очень мотивирующе! Уже сейчас вижу, что буду ходить с удовольствием и достигать своих целей!",
  },
]
